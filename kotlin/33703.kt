...
방석 
$3$개가 있고 첫 번째 방석 위에 크기가 서로 다른 
$N$개의 돌이 일렬로 쌓여있다. 돌의 크기가 클수록 아래에 쌓여있다.
...
건덕이는 방석 위에 돌이 
$1$개만 있다면 해당 돌을 뺄 수 있다.
돌이 
$2$개 이상인 경우, 건덕이는 중간에 있는 돌도 잘 빼기 때문에 빼려는 돌이 맨 밑만 아니라면 뺄 수 있다.
건덕이는 모든 돌을 세 번째 방석으로 옮기고 싶어 한다. 이때 필요한 돌의 최소 이동 횟수를 구해보자.

[입력]
첫 번째 방석 위에 쌓여있는 돌의 개수 $N$이 주어진다. (1 <= N <= 100000)
